...
def faster_vit_0_any_res(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", [224, 224])
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/public/share/challenge_dataset/weights/faster_vit_0.pth.tar")
...
def faster_vit_1_any_res(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", [224, 224])
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/public/share/others/challenge_dataset/weights/fastervit_1_224_1k.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
...
def faster_vit_2_any_res(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", [224, 224])
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/public/share/others/challenge_dataset/weights/fastervit_2_224_1k.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
