...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(-1, H, W, self.num_features).contiguous()
...
def Swin_B(pretrain='/home/weimin.xiao/.cache/torch/hub/checkpoints/swin_base_patch4_window7_224.pth'):
    # pretrain = '/home/weimin.xiao/project/esvit/PPAR_esvit/checkpoint0000.pth'
    # pretrain = '/home/weimin.xiao/project/esvit/PPAR_esvit_pretrain/checkpoint0065.pth'
    pretrain = 'weights/swin_base_patch4_window7_224_22k.pth'
    print(f'loading pretrain model from {pretrain}')
