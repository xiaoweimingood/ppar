...
def remove_module(state_dict):
    return {key.replace('module.base.', ''): value for key, value in state_dict.items()}
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        #                                       progress=progress)
        state_dict = torch.load('/aiprime/weimin.xiao/projects/prime_algo/data/weights/reid_res50_256x128.pth', map_location='cpu')
