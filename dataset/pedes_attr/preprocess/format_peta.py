...
def generate_data_description(data_dir, output_dir, reorder, new_split_path):
    """
    create a dataset description file, which consists of images, labels
    """
    peta_data = loadmat(os.path.join(data_dir, 'PETA.mat'))
    dataset = EasyDict()
    dataset.description = 'peta'
    dataset.reorder = 'group_order'
    dataset.root = os.path.join(data_dir, 'images')
    ...
    if new_split_path:
        ...
        with open(os.path.join(output_dir, 'dataset_zs_run4.pkl'), 'wb+') as f:
        ...
        """
        with open(os.path.join(output_dir, 'dataset_all.pkl'), 'wb+') as f:
            pickle.dump(dataset, f)


if __name__ == "__main__":
    data_dir = '/home/weimin.xiao/dataset/public_dataset/peta/peta_release/'
    output_dir = 'data/PETA/'
    new_split_path = '/home/weimin.xiao/project/Rethinking_of_PAR/data/PETA/'
    new_split_path = None
    generate_data_description(data_dir, output_dir, True, new_split_path)
